/**
 * Terminal Instance - Simplified terminal handling for better responsiveness
 *
 * Uses vanilla xterm.js with minimal customizations for maximum responsiveness.
 * No input buffering or output throttling - direct pass-through for best latency.
 */
...
const BACKEND_RESIZE_DEBOUNCE_MS = 100; // Debounce PTY resize calls
...
/**
 * Simplified terminal instance - no buffering for maximum responsiveness
 */
export class TerminalInstance {
  ...
  /**
   * Handle output data - direct write, no throttling
   */
